...
Tenemos tres operaciones elementales, la \textbf{uniión}, la \textbf{intersección} y el \textbf{complemento}. Cada uno se obtendrá de las tres operaciones en lógica.
...
\begin{example}
    ...
    \[A=\set{-1,1,3,6,10},\qquad B=\set{1,5,10}\]
    Y así, tenemos que:
