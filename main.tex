...
\newtcolorbox[auto counter, number within=chapter]{definition}[2][]{float,colback=ustblue!2, colframe=ustblue, fonttitle=\bfseries, title=Definición~\thetcbcounter \hfill \textcolor{ustblue!10}{ #2 #1}}
\newtcolorbox[auto counter, number within=chapter]{example}[1][]{colback=ustgreen!5, colframe=ustgreen, fonttitle=\bfseries, title=Ejemplo~\thetcbcounter, breakable, label=#1}
